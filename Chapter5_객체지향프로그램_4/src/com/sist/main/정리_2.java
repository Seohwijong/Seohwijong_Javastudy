 ...
 *          new A()
 *          
 *          ****** 인스턴스 메소드 : 인스턴스 변수 , 메소드 , static변수 , static 메소드
 *                               전체를 사용이 가능
 *          ****** static 메소드 : static변수 , static메소드만 사용이 가능
 *                 => 인스턴스를 사용하기 위해서는 객체생성후에 생성이 가능
 *                 
...
class Sawon
{
	...
	Sawon(int sabun2,String name2,String dept2)
	{
		sabun=sabun2;
		name=name2;
		dept=dept2;
...
class Student1
{
	...
	void display()
	{
		...
		System.out.println(this.name); // this. 클래스꺼 같고오는
	}
	void aaa()
	{
		hakbun=1;
