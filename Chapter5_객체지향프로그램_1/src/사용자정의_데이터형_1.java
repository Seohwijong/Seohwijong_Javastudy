 ...
 *           = 인스턴트 변수 : new를 사용할때 저장되는 변수 (new 설정에 따라 따로 저장)
 *             = 클래스객체명.변수명
 *             Card c1=new Card()
 *                  -- 변수 여러개 저장 (. => 주소 접근연산자_
 *             c1.number=10
 ...
 *     ----------------------------------------------------------------------------------------------------
 *        인스턴트변수			   클래스블럭                 new : 새로운 저장공간을 만든다   클래스 전체  
 ...
 *                             }
 *     ----------------------------------------------------------------------------------------------------
 *        지역변수                class ClassName        메소드 호출시마다               메소드 안에서만 사용할 수 있다
 *                             {
 *                                 void display()
 *                                 {
 *                                    int a=10;
 ...
 *        class ClassName   ClassName c=new ClassName()         c.변수                  c=null gc()
 *                                          -----------         c.메소드명
 *                                             생성자
 *        {
 *            String s;
