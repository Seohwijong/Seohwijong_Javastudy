...
public class 사용자정의_데이터형_2 {
	...
	public static void main(String[] args) {
		Board b1=new Board();
		System.out.println("b1="+b1); // b1=Board@515f550a => 7개를 저장할 수 있는 공간
		b1.no=1;
		b1.name="홍길동";
		...
		System.out.println("목적:"+b1.subject);
		System.out.println("컨텐츠:"+b1.content);
		System.out.println("날짜:"+b1.regdate);
