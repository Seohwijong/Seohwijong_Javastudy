 ...
 * 		   (조건) && (조건)
 * 		   ---- 	----
 * 		   false  => 앞이 false면 뒤를 연산하지 않아 효율적    
 * 			|| => true(1)
 * 		   (조건) || (조건)
 * 		   -----
 * 		   true	  => 앞이 true면 뒤를 연산하지 않아 효율적
 * 	 ***6) 대입연산자 ( = , += , -= , op= )
 * 					------------
 * 	 
 * 	 page 38 => 산술연산자
 ...
 *					---
 *					 65+10 => 75
 *					*** char는 모든 연산자를 이용해서 연산처리하면 => 자동으로 int로 변경된다
 *					'A'<60
 *					---
 *					 65
...
// BufferedReader => 예외처리를 해야해서 지금은 안쓴다
public class 산술연산자 {
	...
	public static void main(String[] args) {
		...
		//			 --- 동적 메모리 할당
		//						 --------- 키보드 입력값 (in은 입력, out은 화면출력)(system.(in or out))
