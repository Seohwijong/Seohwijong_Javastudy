...
// 폴더 => 관련된 java파일 저장 => 찾기
// package는 한번만 사용 , import는 여러번 사용가능
// import com.sist.main.클래스구성요소_1; => import(다른 패키지(폴더) 안에 들어있는 클래스를 가져올때 사용)
// import com.sist.main.*;   => *(안에있는 모든 클래스를 가져온다)
// import java.util.*;   import java.util.Scanner;
// 주의점 : 키워드는 사용할 수 없다 (대소문자 구분 => 소문자 권장)
// com.sist.class com.sist.public com.sist.int => 오류(키워드 사용 불가)
