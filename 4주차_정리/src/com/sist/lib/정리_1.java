 ...
 *                                            |
 *                     CheckedExecption		  |         UnCheckedException
 *                     펌파일시 예최처리여부 확인	  |         예외처리여부를 미확인
 ...
 *                     ---------------------------------------------------
 *                     |												 |
 *                IOException : file명 / 디렉토르명                 실행시 에러 (인터프리터)
 *                ClassNotFoundException                         RuntimeException
 *                 => Class.forName("패키지명.클래스명")               		 |
 *                 => 웹 (MVC)                                    NullPotinerExcetpion
 *                InterruptedExcetion (쓰레드)                       String s;
 *                MalforedURLException (ip , web:네트워크)     	    s.replace()
 *                 												  NumberFormatExcetion
 *                InterruptedExcetion (쓰레드)					   Integer,parseInt(" 10");
 *                MalforedURLException (ip , web:네트워크)       	   web
 *                SQLException (문법 => 오라클)                 	   ---
 *                                                                 데이터 전송
 *                                                                 웹주소 / 파일명?no= 10
 ...
 *                      ====> 1) 선언
 *                            2) try~catch
 *                예) public void method() throws 예외처리 클래스 , 예외처리 클래스 ...
 *                   {                           ----------------------------
 ...
 *         LinkedList
 *         
 *         List : 순서가 존재 (인덱스 번호 0번부터 시작) , 중복 데이터 허용
 ...
 *                      클ㄹ래스 여러개 모아서 관리 (Spring , MyBatis)
 *         => put() : 저장시에 사용
 *         => get(key) : 저장된 데이터 읽기
