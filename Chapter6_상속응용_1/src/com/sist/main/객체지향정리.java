 ...
 *           = 정적변수 : 메모리 공간을 한개를 사용한다 (공유변수 , 클래스변수)
 *             - static     => 컴파일시 자동으로 생성
 *           ------------------ 메소드 호출시에 생성 ----------------------
 ...
 *               |   |   |
 *              인간  개   말....    
 *              종단 메소드 : final void aaa() => 변경할 수 없는 메소드 (확장없음) ==> 잘안씀
 *        
 *        3) 생성자 : 5% 
 *            = 객체 생성시 호출되는 메소드
 *            = 멤버변수의 초기화
 ...
 *     ---------------------------------------
 *      protected : 같은 패키지 안에서만 접근이 가능 , 상속이 있는 경우 다른 패키지에 접근이 가능
 *     ---------------------------------------
 ...
 *               ** 개발자들이 겁이 많아서....(오류날까봐 잘사용안하고 새로만들어서 적용)
