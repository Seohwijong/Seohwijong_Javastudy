...
public class 예외처리_예외복구_정리 {
	...
	public static void execute2() throws ArrayIndexOutOfBoundsException , NumberFormatException
	{
		try
		{
			method();
	...
	public static void main(String[] args) {
		method(); //실행시 에러이기 때문에 => 예외처리 생략 가능
	}
}
