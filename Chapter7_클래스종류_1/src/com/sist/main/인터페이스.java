 ...
 *              변수 선언 => (public abstract) void disp();
 *                         구현이 가능한 메소드
 *                              (public) default void aaa(){}
 *                         interface는 상수 , 메소드 public만 사용한다
 *                      = 선언만 되었다 => 상속을 내린다 => 상속받을 클래스를 구현해서 사용 (오버라이딩)
 *                      = 다중상속을 지원한다
 *                        -----
 *                        상속과정
 *                        -----
 ...
 *            
 *            249page
 *            1) 인터페이스는 객체를 생성할 수 없다 (구현이 안된 메소드를 가지고 있기떄문에 메모리에 저장이 불가능)
 *               인터페이스 =new 구현한 클래스()
...
class CC implements AA,BB //CC c=> print() , aaa() , bbb()
{
	//AA.a , BB.a
	public void print()
	{
