 ...
 *      컬렉션 프레임워크
 *      -------------
 *      1. 다수의 데이터를 쉽고 효율적으로 처리할 수 있게 만듬 표준화된 클래스의 집합
 *                     --------------- 자바에서 라이브러리로 지원
 ...
 *     ----------------------------------------------------------------------------------------
 *     1. List
 *        중복 데이터를 저장해야 할때 , 저장 순서는 인덱스 (순서적으로 저장)
 *        인덱스 번호가 항상 0부터 순차적으로 유지
 *        ----------------------------------------------------
